...
const TOUR_STEPS = [
  ...
  },
  {
    ...
    message: 'Get notified when an admin replies to your comment on any lesson. Unread alerts show a red badge here.',
    accent: '#a78bfa',
  },
  {
    targetId: 'nav-search',
    title: 'Search Any Lesson',
    message: 'Press Ctrl+K anywhere to instantly search across all lessons, modules and tracks.',
    accent: '#34d399',
  },
];
