...
function StartScreen({ onStart }) {
  return (
    <div className="flex-1 overflow-y-auto flex items-center justify-center p-6" style={{ background: '#0a0f1c' }}>
...
export default function InterviewPage() {
  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden" style={{ background: '#0a0f1c' }}>
